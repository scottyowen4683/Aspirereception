...
import { Phone, Clock, DollarSign, Zap, CheckCircle, Mail, MapPin, ExternalLink } from 'lucide-react';
      ...
      <header className="fixed top-0 w-full bg-white/95 backdrop-blur-sm border-b border-slate-200 z-50">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <nav className="hidden md:flex gap-8 items-center">
            ...
            <a href="#services" className="text-slate-700 hover:text-blue-600 transition-colors font-medium">AI Receptionist</a>
            <a href="#why-us" className="text-slate-700 hover:text-blue-600 transition-colors font-medium">Why Us</a>
            <a href="https://aspireexecutive.com.au" target="_blank" rel="noopener noreferrer" className="text-slate-700 hover:text-blue-600 transition-colors font-medium flex items-center gap-1">
              Executive Search <ExternalLink className="h-3 w-3" />
            </a>
            <a href="#contact">
              <button className="bg-blue-600 hover:bg-blue-700 text-white rounded-md px-4 py-2">Contact Us</button>
            </a>
          </nav>
        </div>
      </header>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-slate-900 mb-4">Executive Leadership, Innovative Solutions</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            ...
            <div className="rounded-2xl border-2 border-slate-200 hover:border-blue-600 transition-all duration-300 hover:shadow-xl group bg-white">
              <div className="p-6">
                ...
                <p className="text-slate-600 leading-relaxed">Up and running in hours, not weeks. Our efficient deployment process gets you operational immediately.</p>
              </div>
            </div>
      ...
      <section id="why-us" className="py-20 bg-white">
        <div className="container mx-auto px-6">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-slate-900 mb-4">Why Aspire Executive Solutions?</h2>
              <p className="text-xl text-slate-600">Executive expertise meets intelligent innovation</p>
            </div>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex items-center gap-3">
              ...
              />
              <span className="text-sm">© 2025 Aspire Executive Solutions. All rights reserved.</span>
            </div>
            <div className="flex gap-6">
              <a href="#about" className="hover:text-white transition-colors">About</a>
              <a href="#services" className="hover:text-white transition-colors">Services</a>
              <a href="https://aspireexecutive.com.au" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Executive Search</a>
